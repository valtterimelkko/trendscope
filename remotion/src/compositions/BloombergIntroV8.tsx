...
// V8: Using new high-quality logo at 1000px width (2x V7/V6)
...
// Main Composition - Version 8
// V8: Uses new high-quality logo from logo/trendscope-logo-transparent.png
// Logo size: 1000px width (doubled from V7/V6)
export const BloombergIntroV8: React.FC<BloombergIntroProps> = ({
