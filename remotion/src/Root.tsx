...
import { BloombergIntroV10 } from './compositions/BloombergIntroV10';
  ...
  return (
    <>
      <Folder name="marketing-videos">
        ...
        <Composition
          id="TrendscopeBloombergIntroV10"
          component={BloombergIntroV10}
          durationInFrames={1560} // 52 seconds @ 30fps (DOUBLED DURATIONS)
          fps={FPS}
          width={WIDTH}
          height={HEIGHT}
          defaultProps={{
