    ...
    <div className="min-h-screen bg-background flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-primary-light items-center justify-center p-12">
        <div className="max-w-md text-center">
          ...
          <p className="text-muted">
            Join thousands of creators using Content Studio to write,
            collaborate, and publish their best work.
          </p>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <p className="text-muted mb-8">Sign in to continue creating</p>
          ...
          <button
            ...
            disabled={loading}
            className="w-full mt-3 py-3 px-4 text-primary font-medium hover:bg-primary-light rounded-lg transition-colors disabled:opacity-50"
          >
